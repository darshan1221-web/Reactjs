...
function Hero() {
  return (<header id="home" className="hero">
    <div className="container">
  ...
  return (
    <div className="container">
      ...
      <div className="row g-4">
        ...
        <Servicesname name="Precision Cut" description="Customized haircut to suit your style and face shape." />
        <Servicesname name="Color & Highlights" description="Vibrant color, balayage, ombre, and highlights using low-damage formulas." />
        <Servicesname name="Keratin Treatment" description="Smooth frizz and enhance shine with our nourishing keratin treatment." />
        <Servicesname name="Deep Conditioning" description="Restore moisture and vitality with our intensive conditioning treatments." />
        <Servicesname name="Bridal Styling" description="Elegant updos and styling for your special day." />
        <Servicesname name="Scalp Spa" description="Relaxing scalp massage and treatment to promote healthy hair growth." />       
...
function Team() {
  return (<section id="team" className="py-5 bg-light">
    <div className="container">
...
function Reviwes(props){
  let { description,name,rating } = props;
  return(<div className="col-md-4">
            <div className="testimonial-card p-4">
              <p className="small">
                {description}
              </p>
              <h6 className="mt-3 fw-bold text-white">{name}</h6>
...
function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-5">
      <div className="container">
        <h3 className="mb-4 text-white text-center">What Our Clients Say ✨</h3>
        <div className="row g-4">
          <Reviwes name="Sophia R." description="Salon Lumière transformed my hair! The stylists are incredibly talented, and the atmosphere is so relaxing. I left feeling like a new person!" rating="⭐⭐⭐⭐⭐" />
          <Reviwes name="Liam K." description="I've never had such a personalized haircut experience. The team really listened to what I wanted and delivered beyond my expectations. Highly recommend!" rating="⭐⭐⭐⭐⭐" />
          <Reviwes name="Olivia M." description="The color treatment I received was fantastic. My hair feels healthy and looks vibrant. The salon's use of premium products really shows!" rating="⭐⭐⭐⭐⭐" />
...
function Salon(props) {
  ...
  body {
    background:
      ...
      linear-gradient(135deg, #6a3accff, #c04ee2ff 45%, #deb4e6ff 100%);
...
.testimonial-card:hover {
  ...
  box-shadow: 0 12px 40px rgba(199,125,255,0.35);
  border-color: var(--accent);
}
