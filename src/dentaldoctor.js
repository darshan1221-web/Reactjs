...
function Dance() {
  ...
  {/* HERO */}
  <header id="home" className="hero py-5 ">
  ...
  <section id="services" className="py-5 bg-light">
    <div className="container">
      ...
      <div className="row g-4">
        <div className="col-md-4">
          <div className="card h-100 card-hover">
            ...
            <div className="card-body">
              <h5 className="card-title">Dental Cleanings</h5>
              <p className="card-text small text-muted">Thorough professional cleaning to remove plaque and polish teeth.</p>
            </div>
        ...
        <div className="col-md-4">
          <div className="card h-100 card-hover">
            <img src="https://images.unsplash.com/photo-1588774069184-0d3d0a3ccf0a" className="card-img-top" alt="tooth restoration" />
            <div className="card-body">
              <h5 className="card-title">Fillings &amp; Crowns</h5>
              <p className="card-text small text-muted">Tooth-colored fillings and durable crowns that blend with your smile.</p>
            </div>
            <div className="card-footer bg-transparent">
              <a href="#contact" className="btn btn-outline-primary btn-sm">Learn More</a>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card h-100 card-hover">
            <img src="https://images.unsplash.com/photo-1542736667-069246bdbc53" className="card-img-top" alt="whitening" />
            <div className="card-body">
              <h5 className="card-title">Teeth Whitening</h5>
              <p className="card-text small text-muted">Safe, effective whitening for a brighter smile.</p>
            </div>
            <div className="card-footer bg-transparent">
              <a href="#contact" className="btn btn-outline-primary btn-sm">Get Whitening</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container">
      ...
      <div className="row g-4">
        <div className="col-md-4">
          <div className="card p-3 h-100 card-hover">
            <blockquote className="blockquote mb-0">
              <p className="small">“I was nervous about my root canal but Dr. Mehra was calm and professional — painless experience!”</p>
              <footer className="blockquote-footer small mt-2">R. Sharma</footer>
            </blockquote>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card p-3 h-100 card-hover">
            <blockquote className="blockquote mb-0">
              <p className="small">“My teeth whitening results are amazing — staff were so kind.”</p>
              <footer className="blockquote-footer small mt-2">S. Kaur</footer>
            </blockquote>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card p-3 h-100 card-hover">
            <blockquote className="blockquote mb-0">
              <p className="small">“Great with kids — my daughter loves visiting the clinic.”</p>
              <footer className="blockquote-footer small mt-2">A. Desai</footer>
            </blockquote>
          </div>
        </div>
      </div>
