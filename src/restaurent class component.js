      ...
      <div className="col-lg-4">
        <div className="card my-3">
          <div className="card-header text-bg-danger d-flex justify-content-between">
            <h5>darshan</h5>
            <h5><span className="badge bg-white text-primary">01</span></h5>
          </div>
          <div className="card-body">
            <button type="button" className="btn btn-primary w-100">Thali - <span className="badge bg-white text-primary">1</span></button>
